    ...
    methods: {
      async register() {
        try {
          ...
          let response = await UserService.register(this.user.email, this.user.password, this.user.passwordRepeat, this.user.name, this.user.birthdate, this.user.gender);
        } catch(e){
          this.error = e;
        }
      },
